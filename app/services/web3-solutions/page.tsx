    ...
    return (
        <div className="min-h-screen bg-black pt-16 font-mono">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <div>
                            ...
                            <p className="text-gray-400 mb-6 leading-relaxed">
                                I specialize in creating decentralized applications that leverage blockchain
            ...
            <section className="py-16 bg-gray-900/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-bold text-white mb-12 text-center">Web3 Services</h2>
